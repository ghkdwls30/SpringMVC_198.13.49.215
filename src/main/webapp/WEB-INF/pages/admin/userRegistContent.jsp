			...
			<div class="card">
				...
				<div class="card-body">
				           <div class="form-group row">
                               ...
                               <div class="col-sm-11">
                                   <input value="" type="text" class="form-control" name="company" placeholder="사용자의 회사명을 입력하세요.">
                               </div>
                           </div>
                           <div class="form-group row">
                               <label for="fname" class="col-sm-1 text-left control-label col-form-label">이름</label>
                               <div class="col-sm-11">
                                   <input value="" type="text" class="form-control" name="name" placeholder="이름을 입력하세요.">
                               </div>
                           </div>
                           <div class="form-group row">
                               ...
                               <div class="col-sm-11">
                                   <input
                                   <c:if test="${PAGE_TYPE eq 'E'}">readonly="readonly"</c:if>
                                    value="" type="text" class="form-control" name="account" placeholder="아이디를 입력하세요.">
                               </div>
                           </div>
                           <div class="form-group row">
                               <label for="lname" class="col-sm-1 text-left control-label col-form-label">패스워드</label>
                               <div class="col-sm-11">
                                   <input value="" type="text" class="form-control" name="password" placeholder="패스워드를 입력하세요.">
                               </div>
                           </div>
							<div class="form-group row">
                               <label for="lname" class="col-sm-1 text-left control-label col-form-label">패스워드 확인</label>
                               <div class="col-sm-11">
                                   <input type="text" value="" class="form-control" name="password_confirm" placeholder="동일한 패스워드를 다시 한번 입력하세요.">
                               </div>
                           </div>
                           <div class="form-group row">
                               <label for="lname" class="col-sm-1 text-left control-label col-form-label">모통슬롯개수</label>
                               <div class="col-sm-11">
                                   <input type="number" value="" class="form-control" name="mobileSearchSlotCnt"  placeholder="사용자에게 부여할 모통슬롯개수를 입력하세요.">
                               </div>
                           </div>
                           <div class="form-group row">
                               <label for="lname" class="col-sm-1 text-left control-label col-form-label">자동슬롯개수</label>
                               <div class="col-sm-11">
                                   <input type="number" value="" class="form-control" name="autoSlotCnt" placeholder="사용자에게 부여할 자동슬롯개수를 입력하세요.">
                               </div>
                           </div>
                           <div class="form-group row">
                               <label for="lname" class="col-sm-1 text-left control-label col-form-label">연관슬롯개수</label>
                               <div class="col-sm-11">
                                   <input type="number" value="" class="form-control" name="relSlotCnt" placeholder="사용자에게 부여할 연관슬롯개수를 입력하세요.">
                               </div>
                           </div>
                           <div class="form-group row">
                               ...
                               <div class="col-sm-11">
                                   <div class="input-group">
	                                    <input value="" type="text" class="form-control" id="datepicker-autoclose_1" name="startedAt" placeholder="yyyy-mm-dd" data-date-format="yyyy-mm-dd">
                               ...
                               <div class="col-sm-11">
                                   <div class="input-group">
	                                    <input value="" type="text" class="form-control" id="datepicker-autoclose_2" name="endedAt" placeholder="yyyy-mm-dd" data-date-format="yyyy-mm-dd">
	                                    <div class="input-group-append">
	                                        <span class="input-group-text"><i class="fa fa-calendar"></i></span>
	                                    </div>
                                	</div>
                       ...
                       <div class="border-top">
                           <div class="card-body text-center">
                           			<button type="button" class="btn btn btn-success" onclick="registUser();">등록</button>
